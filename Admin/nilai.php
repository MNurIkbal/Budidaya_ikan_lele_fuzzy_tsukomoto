							...
							<div class="card">
								<form method="POST" action="">
									...
									<div class="card-body">
										...
										<br>
										<p>Jenis Kelamin</p>
										<input type="text" class="form-control" id="disableinput" value="<?php $jk = ($data['jeniskelamin'] == 'L') ? "Laki-laki" : "Perempuan";
																											echo $jk; ?>" disabled>
										<br>
										<p>Alamat</p>
								...
								if (isset($_POST['submit'])) {
									...
									if (!$count) {
										...
										$predikat_z = calculateRules($luasKolam, $jumlahBibit, $jumlahPakan);
